...
class _HomeScreenState extends State<HomeScreen> {
  ...
  AppBar _buildAppBar(BuildContext context) {
    const String tempIcon = "assets/icons/icon/icon_elswhere_home.svg";
  ...
  Widget _buildHotProductButton() {
    const String hotIcon = "assets/icons/icon/icon_hot.svg";
  ...
  Widget _buildAttentionProductButton(BuildContext context) {
    const String attentionIcon = "assets/icons/icon/icon_attention.svg";
    return GestureDetector(
      onTap: () {
        Navigator.push(
            context,
